...
<body>
    ...
    <section id="chat" class="chat" style="margin: 100px">
        <div class="row d-flex justify-content-center my-3">
            <div class="title">
                <h1 class="text-center" style="color: #AAC4FF; font-weight: bold">CHAT DOKTER</h1>
            </div>
            <div class="erga d-flex justify-content-center my-3">
                <div class="col-8">
                    <div class="card ms-10 me-10 mb-4" style="background-color: #B1B2FF; color: white; border-radius: 10px">
                        <div class="card-body" style="margin: 5px 0 5px 0">
                            <div class="row">
                                <div class="col-lg-3">
                                    <img src="img/dokter1.png" style="border-radius: 10px; heigh: 100px; width: 200px" alt="">
                                </div>
                                ...
                                <div class="d-flex justify-content-end">
                                    <button type="button" class="btn btn-light" style="color: #FFFFFF; border-radius: 16px;"><a href="bayar.php" style="color: #B1B2FF; font-family: 'Open Sans'; font-style: normal; font-weight: 600; font-size: 22px;">Konsultasi</a></button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-8">
                    <div class="card ms-10 me-10 mb-4" style="background-color: #B1B2FF; color: white; border-radius: 10px">
                        <div class="card-body" style="margin: 5px 0 5px 0">
                            <div class="row">
                                <div class="col-lg-3">
                                    <img src="img/dokter2.png" style="border-radius: 10px; heigh: 100px; width: 200px" alt="">
                                </div>
                                <div class="col-lg-9" style="">
                ...
                <div class="col-8">
                    <div class="card ms-10 me-10 mb-4" style="background-color: #B1B2FF; color: white; border-radius: 10px">
                        <div class="card-body" style="margin: 5px 0 5px 0">
                            <div class="row">
                                <div class="col-lg-3">
                                    <img src="img/dokter3.png" style="border-radius: 10px; heigh: 100px; width: 200px" alt="">
                                </div>
                                <div class="col-lg-9" style="">
                ...
                <div class="col-8">
                    <div class="card ms-10 me-10 mb-4" style="background-color: #B1B2FF; color: white; border-radius: 10px">
                        <div class="card-body" style="margin: 5px 0 5px 0">
                            <div class="row">
                                <div class="col-lg-3">
                                    <img src="img/dokter4.png" style="border-radius: 10px; heigh: 100px; width: 200px" alt="">
                                </div>
                                <div class="col-lg-9" style="">
