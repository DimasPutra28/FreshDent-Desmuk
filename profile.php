...
<body>
    ...
    <div class="direktori" style="padding: 100px">
    ...
    <section id="propil" style="padding-bottom: 100px">
        <div class="row" style="margin: 0 20px 43px 19px">
            <div class="col-lg-4">
                <div class="card text-center" style="background-color: #AAC4FF; color: white; height: 528px">
                    <div class="card-body mb-2" style="padding-bottom: 30px ">
                        <img src="img/profil.png" alt="" style="padding-top: 30px">
                        <h3 style="margin-top: 10px; font-weight: 500">Vanadya Lacerta</h3>
                        <h3 style="margin-top: 10px; font-weight: 400">12345678</h3>
                        <h1>PERIKSA GIGI </h1>
                        <a href="riwayat.php" class="btn btn-light mt-5" style="background-color: #EEF1FF; color: #B1B2FF; font-size: 20px;font-weight: 500; border-radius: 20px">Riwayat Medis</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body" style="font-size: 30px; padding: 40px">
                        <div class="row my-2">
                            <div class="col-lg-4">
                                <span style="font-weight: 700">Full Name</span>
                            </div>
                            <div class="col-lg-7">
                                <span>Vanadya Lacerta</span>
                            </div>
                            <div class="col-lg-1">
                                <img src="img/edit.png" style="height: 50px; width: 50px" class="img-fluid" alt="">
                            </div>
                            <hr class="mt-2" style="border: 2px solid">
                        </div>
                        ...
                        <div class="row my-2">
                            ...
                            <div class="col-lg-7">
                                <span>Pakuwon City, Surabaya</span>
                            </div>
                            <div class="col-lg-1">
                                <img src="img/edit.png" style="height: 50px; width: 50px" class="img-fluid" alt="">
                            </div>
